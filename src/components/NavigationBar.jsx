...
const NavigationBar = () => {
    ...
    return(
        <div className ='w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 border-b-4 border-black'>
        <div>
            {/* Potential Logo */}
        </div>
        {/* Navigation Menu */}
            <ul className='hidden md:flex'>
            <li className="group hover:text-[#2a7a80] duration-300">
            <a href='/' className="flex justify-between items-center w-full">Home
            <BsArrowClockwise className='ml-2 group-hover:rotate-180 duration-500' size={25}/>
            </a>
            </li>
            <li className="group hover:text-[#e9da50] duration-300">
            <a href='/experience' className="flex justify-between items-center w-full">Experience
            <MdComputer className='ml-2 group-hover:rotate-180 duration-500' size={25}/>
                ...
                <li className="group hover:text-[#0072b1] duration-300">
                    ...
                    href="https://www.linkedin.com/in/victor-conde-85538222b">LinkedIn 
        ...
        <li className='py-4 text 6xl w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#2a7a80]'><a href ='/' onClick={hClick} className='flex justify-between items-center w-full text-white'>Home<BsArrowClockwise className='ml-2 group-hover:rotate-180 duration-500' size={25}/></a></li>
        <li className='py-4 text 6xl w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#e9da50]'><a href ='/experience' onClick={hClick} className='flex justify-between items-center w-full text-white'>Experience<MdComputer className='ml-2 group-hover:rotate-180 duration-500' size={25}/></a></li>
        <li className='py-4 text 6xl w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-500 bg-[#0072b1]'><a className='flex justify-between items-center w-full text-white' href="https://www.linkedin.com/in/victor-conde-85538222b">LinkedIn <FaLinkedin size={25}/></a></li>
